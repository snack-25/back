...
export class CompaniesController {
  ...
  @Get('')
  public findAll(): Promise<CompanyResponseDto[]> {
  ...
  @Get(':id')
  public findOne(@Param('id') id: string): Promise<CompanyResponseDto> {
  ...
  @Post('')
  public create(@Body() createCompanyDto: CreateCompanyDto): Promise<CompanyResponseDto> {
